...
// URL backend - đổi nếu deploy production
...
export default function LoginPage() {
  ...
  // Hiển thị lỗi OAuth2 nếu backend redirect về với ?error=...
  ...
  // Redirect sang Google OAuth2
  const handleGoogleLogin = () => {
    window.location.href = `${API_BASE}/oauth2/authorize/google`;
  };

  // Redirect sang Facebook OAuth2
  const handleFacebookLogin = () => {
    window.location.href = `${API_BASE}/oauth2/authorize/facebook`;
  };
          ...
          <div className={styles.card}>
            ...
            <form onSubmit={handleSubmit} noValidate>
              <div className={styles.fieldGroup}>
                ...
                {/* Nút OAuth2 — chuyển hướng sang backend */}
